...
Desenvolvedor com foco em arquitetura de software, atuando como QA Specialist na DBC Company em projetos do setor financeiro e de aviação — incluindo Gol/Smiles, Sicredi e DBC Captação.
...
### Analista de QA | DBC Company
*março/2025 - Presente*
- Atuação em projetos do setor financeiro e de aviação (Gol/Smiles, Sicredi)
- Automação de testes web, mobile e API com Cypress, Selenium, Appium, Rest Assured
- Metodologias ágeis (Scrum, Kanban) e ferramentas como Jira, Zephyr Scale, Confluence
- CI/CD com GitLab, SonarQube e análise de qualidade de código
- BDD com Cucumber/Gherkin e estratégia de testes (pirâmide, quadrantes, matriz de riscos)

### Estagiário | DBC Company
*junho/2024 - março/2025*
- Desenvolvimento full-stack em projeto real com Java, Spring Boot, JavaScript, CSS, HTML
- Mobile com Flutter e Docker para ambientes isolados
...
### DBC Captação - Sistema de Recrutamento
*Desenvolvimento Full-Stack | Ambiente de Produção*
- Sistema completo para gestão de processos seletivos da DBC
- Frontend: React + TypeScript + Tailwind CSS
- Backend: Java + Spring Boot + PostgreSQL
- CI/CD: GitLab com SonarQube e automação de testes
- **Status:** Em produção com merge real via PR

### Gol/Smiles - Testes Automatizados
*Qualidade de Software | Automação Web e API*
- Automação completa de testes funcionais e regressivos
- Cypress para web, Rest Assured para APIs, JMeter para performance
- Integração com Jira para gestão de defeitos
- **Status:** Ativo com ~500 casos de test automatizados

## 🎯 Foco atual

- **Arquitetura de sistemas** e design de soluções escaláveis
- **DevOps** e pipelines CI/CD robustos
- **Testes shift-left** e qualidade integrada ao desenvolvimento
- **Automação avançada** com Cypress, Selenium e Appium
- **Qualidade de código** com SonarQube e boas práticas

## 📞 Contato

- 📧 Email: [souzawagner.ti@gmail.com](mailto:souzawagner.ti@gmail.com)
- 💼 LinkedIn: [wagner-silva-souza-3a840935](https://linkedin.com/in/wagner-silva-souza-3a840935)
- 🐙 GitHub: [Wagner-Dev-Souza](https://github.com/Wagner-Dev-Souza)
- 🐱 GitLab: [Wagner-Dev-Souza](https://gitlab.com/Wagner-Dev-Souza)

---

<!-- Cobrinha de contribuições - gerada automaticamente pela Action em .github/workflows/cobrinha.yml -->
<div align="center">
  <picture>
